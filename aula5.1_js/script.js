...
tabs.forEach((tab) => {
  tab.addEventListener("click", () => {
    ...
    if (currentOp === "quadrado") {
      btnLabel.textContent = "Calcular Quadrado";
    } else if (currentOp === "cubo") {
      btnLabel.textContent = "Calcular Cubo";
    } else if (currentOp === "raiz") {
      btnLabel.textContent = "Calcular Raiz Quadrada";
    }
...
function calculate() {
  ...
  if (currentOp === "quadrado") {
    ...
    if (n < 0) {
      errorMsg.textContent = "Não é possível calcular a raiz quadrada de um número negativo.";
